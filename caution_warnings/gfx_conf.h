  ...
  LGFX(void)
  {
    ...
    _panel_instance.light(&_light_instance);

        {
          ...
          touch_cfg.x_min      = 100;   
          touch_cfg.x_max      = 4000; 
          touch_cfg.y_min      = 100;   
          touch_cfg.y_max      = 4000;
          ...
          touch_cfg.pin_sclk   = GPIO_NUM_12;
          touch_cfg.pin_mosi   = GPIO_NUM_11;  
          touch_cfg.pin_miso   = GPIO_NUM_13;   
          touch_cfg.pin_cs     = GPIO_NUM_0;
